...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "BDRCoin Genesis Blockchain Technology: The Beginning 11/19";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1574077283, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1574077283;
        genesis.nBits    = 0x1e0fffff;
        genesis.nNonce   = 342209;

        
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000004d94f305d536dfac7c56fb2d7759502ea4f62be751d81e054432043cc16"));
        assert(genesis.hashMerkleRoot == uint256("0x0706fabd21aa3c6c60cbce21ecbc413ab7d7b87c51931a66ba2cc98c69586c4f"));

        vSeeds.push_back(CDNSSeedData("seed1", "80.209.237.232"));
        vSeeds.push_back(CDNSSeedData("seed2", "80.209.226.140"));
        vSeeds.push_back(CDNSSeedData("seed3", "195.181.240.110"));
