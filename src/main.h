...
static const unsigned int DEFAULT_MAX_ORPHAN_BLOCKS = 150;
...
static const signed int POS_JUMPSTART_FORK_BLOCK = 4000;

inline bool IsProtocolV2(int nHeight) { return TestNet() || nHeight > 0; }
inline bool IsProtocolV3(int nHeight) { return TestNet() || nHeight > 99000; }

inline int64_t FutureDriftV1(int64_t nTime) { return nTime + 10 * 60; }
inline int64_t FutureDriftV2(int64_t nTime) { return nTime + 20 * 60; }

inline int64_t FutureDrift(int64_t nTime, int nHeight) { return IsProtocolV2(nHeight) ? FutureDriftV2(nTime) : FutureDriftV1(nTime); }

inline unsigned int GetTargetSpacingV1(int nHeight) { return IsProtocolV2(nHeight) ? 69 : 60; }
inline unsigned int GetTargetSpacingV2(int nHeight) { return IsProtocolV2(nHeight) ? 249 : 240; }
...
public:
    ...
    {
        return Hash9(BEGIN(nVersion), END(nNonce)); //x11
    }
