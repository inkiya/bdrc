...
// Copyright (c) 2017 The BDRCoin developers
...
bool ComputeNextStakeModifier(const CBlockIndex* pindexPrev, uint64_t& nStakeModifier, bool& fGeneratedStakeModifier)
{
	...
	if (pindexBest->nHeight > POS_JUMPSTART_FORK_BLOCK+1){
		vSortedByTimestamp.reserve(64 * nModifierInterval / GetTargetSpacingV2(pindexPrev->nHeight));
	}else{
		vSortedByTimestamp.reserve(64 * nModifierInterval / GetTargetSpacingV1(pindexPrev->nHeight));
	}	
